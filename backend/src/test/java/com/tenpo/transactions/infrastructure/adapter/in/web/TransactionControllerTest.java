...
class TransactionControllerTest {
    ...
    @Test
    void getById_WhenTransactionExists_ShouldReturnTransaction() throws Exception {
        when(transactionUseCase.getById(1)).thenReturn(Optional.of(sampleTransaction));
        when(mapper.toResponseDto(sampleTransaction)).thenReturn(sampleResponseDto);
    ...
    @Test
    void getById_WhenTransactionDoesNotExist_ShouldReturnNotFound() throws Exception {
        when(transactionUseCase.getById(anyInt())).thenReturn(Optional.empty());
